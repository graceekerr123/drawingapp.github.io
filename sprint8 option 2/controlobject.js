...
class ControlObject{
    ...
    else if(this.mouseDown == true && this.inBoundsCheck(this.xMouse, this.yMouse, this.Dx, this.Dy, this.Dw, this.Dh) && Button.Shape == "S"){    
        // line object is created, using the dimesions of the draw guide
            var temp = new Brush(this.xMouse, this.yMouse, 5, Swatch.Colour);
            // add new object to object list
            this.ObjectSet.push(temp);  
        }

        else if(this.mouseDown == true && this.inBoundsCheck(this.xMouse, this.yMouse, this.Dx, this.Dy, this.Dw, this.Dh) && Button.Shape == "M"){    
            // line object is created, using the dimesions of the draw guide
                var temp = new Brush(this.xMouse, this.yMouse, 10, Swatch.Colour);
                // add new object to object list
                this.ObjectSet.push(temp);  
            }
            else if(this.mouseDown == true && this.inBoundsCheck(this.xMouse, this.yMouse, this.Dx, this.Dy, this.Dw, this.Dh) && Button.Shape == "L"){    
                // line object is created, using the dimesions of the draw guide
                ...
                else if(this.mouseDown == true && this.inBoundsCheck(this.xMouse, this.yMouse, this.Dx, this.Dy, this.Dw, this.Dh) && Button.Shape == "XL"){    
                    // line object is created, using the dimesions of the draw guide
                        var temp = new Brush(this.xMouse, this.yMouse, 30, Swatch.Colour);
                        // add new object to object list
                        this.ObjectSet.push(temp);  
                    }
    }
    ...
    draw(){
        ...
        if(Button.Shape == "Rectangle" || Button.Shape == "Ellipse" || Button.Shape == "Triangle" || Button.Shape == "Polygon"){
            this.drawRectGuide(this.xMouseStart, this.yMouseStart, this.w, this.h, colArray[0][0]);
        }else if(Button.Shape == "Line"){
            ctx.beginPath();
